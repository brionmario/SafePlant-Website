		...
		<div class="container">
			<center><div id="page_caption">
				<div class="page_title_wrapper">
					<br>
					<h4 class="text-uppercase">Thank you for your volunteering</h4><br>
					<p style="font-size:16px">We have sent you an email regarding your registration. If you need further information, please use the telephone number listed in the email to talk to one of our staff members. </p><br>
					<p>We will be in touch with you soon.<br> Click <a href="login.php"><b style="color: #FF0004">here</b></a> to go to the login page.</p>
